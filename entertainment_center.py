...
# initialize some movie instances
Pulp_Fiction=Movie(
    "Pulp Fiction",
...
Mr_Six=Movie(
    "Mr Six",
    "https://upload.wikimedia.org/wikipedia/en/2/2e/Mr._Six_%28film%29_poster.jpeg",
    "https://www.youtube.com/watch?v=Td9xm-SgYtw")
...
movies=[Pulp_Fiction,Mr_Six,gangs_of_NY,The_Departed,The_blind_side,Ant_Man] # initialize a list which includes my favorite movies
